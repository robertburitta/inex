    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-grow">
              ...
              <main className="mt-8 mx-auto max-w-7xl px-4 sm:mt-10 sm:px-6 md:mt-12 lg:mt-16 lg:px-8 xl:mt-20">
                <div className="sm:text-center lg:text-left">
                  <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                    ...
                    <span className="block text-blue-600 xl:inline">finanse</span>
                  </h1>
                  <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                    Śledź swoje przychody i wydatki, analizuj budżet i osiągaj swoje cele finansowe. 
              ...
              <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                ...
                <div className="relative">
                  ...
                  <div className="ml-16">
                    ...
                    <p className="mt-2 text-base text-gray-500">
                      Ustaw cykliczne płatności i nigdy nie zapomnij o ważnych opłatach.
                    </p>
                  </div>
                </div>
        ...
        <div className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="lg:text-center">
              <h2 className="text-base text-blue-600 font-semibold tracking-wide uppercase">Dlaczego warto</h2>
              <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
        ...
        <div className="py-24 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="lg:text-center">
              <h2 className="text-base text-blue-600 font-semibold tracking-wide uppercase">Jak to działa</h2>
              <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            ...
            <div className="mt-10">
              <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
                ...
                <div className="relative">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Rozpocznij od dodania swoich pierwszych przychodów i wydatków.
                  </p>
                </div>
                ...
                <div className="relative">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Korzystaj z analiz i raportów, aby lepiej zarządzać swoimi finansami.
                  </p>
                </div>
              </div>
            </div>
